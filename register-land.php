...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['submit_property'])) {
    ...
    // گام ۲: مشخصات اجباری زمین (فیلدهای حذف شده از اعتبارسنجی حذف شدند)
    if (empty($_POST['land_area'])) $errors[] = 'لطفاً مساحت زمین را وارد کنید.';
    if (empty($_POST['land_type'])) $errors[] = 'لطفاً کاربری زمین را انتخاب کنید.';
    if (empty($_POST['land_width'])) $errors[] = 'لطفاً عرض زمین را وارد کنید.';
    if (empty($_POST['land_length'])) $errors[] = 'لطفاً طول زمین را وارد کنید.';
    if (empty($_POST['land_ownership'])) $errors[] = 'لطفاً وضعیت مالکیت را انتخاب کنید.';
    ...
    $newAd = [
        ...
        // فیلدهای اختصاصی زمین (فیلدهای حذف شده حذف شدند)
        'land_area' => $_POST['land_area'] ?? '0',
        'land_type' => $_POST['land_type'] ?? '',
        'land_width' => $_POST['land_width'] ?? '0',
        'land_length' => $_POST['land_length'] ?? '0',
        'land_front_width' => $_POST['land_front_width'] ?? '0',
        'land_blocks' => $_POST['land_blocks'] ?? '0',
        'land_direction' => $_POST['land_direction'] ?? '',
        'land_shape' => $_POST['land_shape'] ?? '',
        'land_deed_status' => $_POST['land_deed_status'] ?? '',
        'land_deed_type' => $_POST['land_deed_type'] ?? '',
        'land_setback_status' => $_POST['land_setback_status'] ?? '',
        'land_ownership' => $_POST['land_ownership'] ?? '',
        'amenities' => isset($_POST['land_amenities']) ? array_values($_POST['land_amenities']) : [],
    ...
    <body style='font-family: Vazirmatn, sans-serif; text-align: center; padding: 50px; direction: rtl;'>
        <h2 style='color: green;'>✅ آگهی زمین با موفقیت ثبت شد!</h2>
    ...
    <form method="POST" action="" id="propertyForm" enctype="multipart/form-data" novalidate>
        ...
        <div class="step-content" id="step2">
            ...
            <div class="row-half">
                <div class="form-group">
                    <label>جهت ملک</label>
                    <select class="form-select" id="regLandDirection" name="land_direction">
                        <option value="">انتخاب کنید</option>
                        <option>شمالی</option>
                        <option>جنوبی</option>
                        <option>شرقی</option>
                        <option>غربی</option>
                        <option>شمال شرقی</option>
                        <option>شمال غربی</option>
                        <option>جنوب شرقی</option>
                        <option>جنوب غربی</option>
                    </select>
                </div>
                <div class="form-group">
                    <label>شکل زمین</label>
                    <select class="form-select" id="regLandShape" name="land_shape">
                        <option value="">انتخاب کنید</option>
                        <option>مستطیل</option>
                        <option>مربع</option>
                        <option>مثلث</option>
                        <option>ذوزنقه</option>
                        <option>نامنظم</option>
                    </select>
                </div>
            </div>
            ...
            <div class="row-half">
                <div class="form-group">
                    ...
                    <select class="form-select" id="regLandDeedStatus" name="land_deed_status">
                        <option value="">انتخاب کنید</option>
                ...
                <div class="form-group">
                    <label>نوع سند</label>
                    <select class="form-select" id="regLandDeedType" name="land_deed_type">
                        <option value="">انتخاب کنید</option>
                        <option>تک‌برگ</option>
                        <option>دفترچه‌ای</option>
                        <option>مشاعی</option>
                    </select>
                </div>
            </div>
            ...
            <div class="row-half">
                <div class="form-group">
                    ...
                    <select class="form-select" id="regLandSetbackStatus" name="land_setback_status">
                        <option value="">انتخاب کنید</option>
                        <option>دارد</option>
                        <option>ندارد</option>
        ...
        <div class="step-content" id="step5">
            ...
            <div class="form-group">
                ...
                <textarea class="form-textarea" id="regFullDesc" name="full_description" placeholder="شرح کامل مشخصات و وضعیت زمین..." maxlength="1000" oninput="document.getElementById('charCount').innerText = this.value.length"></textarea>
...
<script>
    ...
    function updatePreview() {
        ...
        document.getElementById('previewContent').innerHTML = 
            ...
            '<div class="preview-card-title" style="font-size:14px;">مشخصات زمین</div>' +
            specsHtml +

            '<div class="preview-card-title" style="font-size:14px;">امکانات و وضعیت</div>' +
